...
// API para kunin yung list ng mga waiting tourists
// ginagamit to ng queue lobby sa frontend para igenerate yung mga tourist blocks para i-display
...
try {
    // tiga kuha ng lahat ng waiting at active tourists na walang guide assignment
