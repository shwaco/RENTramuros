...
<body class="flex h-screen bg-gray-50 antialiased overflow-hidden">
    ...
    <aside class="relative h-screen bg-gray-800 text-white flex flex-col shadow-2xl transition-all duration-300 w-20 hover:w-64 overflow-hidden group hidden md:flex shrink-0 z-50">
        ...
        <nav class="flex-1 px-4 py-6 space-y-3 overflow-y-auto overflow-x-hidden">
            ...
            <a href="manage_events.php" class="flex items-center py-3 bg-[#7a3229] text-white rounded-lg shadow-md transition whitespace-nowrap">
                <div class="w-12 flex justify-center shrink-0"><i class="fas fa-calendar-alt text-xl"></i></div>
                <span class="ml-3 font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300">Events</span>
            </a>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8 border border-gray-100">
                <div class="flex justify-between items-center mb-6 border-b pb-4">
                    <h2 class="text-2xl font-bold text-gray-800">
                        <i class="fas fa-list-ul mr-2 text-[#7a3229]"></i>Upcoming Events
                    </h2>
                    <button onclick="openAddEventModal()" class="bg-[#7a3229] text-white px-5 py-2 rounded-lg font-semibold hover:bg-red-900 transition flex items-center shadow-sm">
        ...
        <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto relative">
            ...
            <div class="flex justify-between items-center mb-6 border-b pb-3">
                <h2 id="modal-title" class="text-xl font-bold text-gray-800">
                    <i class="fas fa-calendar-plus mr-2 text-[#7a3229]"></i>Create Event
                </h2>
            ...
            <form id="add-event-form" class="space-y-4">
                <div>
                    ...
                    <input type="text" id="event-name" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Date</label>
                    <input type="text" id="event-date" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Time</label>
                    <input type="text" id="event-time" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Location</label>
                    <input type="text" id="event-location" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Filename</label>
                    <input type="text" id="event-img" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                ...
                <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" id="submit-btn" class="px-4 py-2 bg-[#7a3229] text-white rounded-lg font-semibold hover:bg-red-900 transition shadow-sm">Save Event</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto relative">
            ...
            <div class="flex justify-between items-center mb-6 border-b pb-3">
                <h2 class="text-xl font-bold text-gray-800">
                    <i class="fas fa-edit mr-2 text-[#7a3229]"></i>Edit Event
                </h2>
            ...
            <form id="edit-event-form" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Event Name</label>
                    <input type="text" id="edit-event-name" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Date</label>
                    <input type="text" id="edit-event-date" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Time</label>
                    <input type="text" id="edit-event-time" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Location</label>
                    <input type="text" id="edit-event-location" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Image Link/Filename</label>
                    <input type="text" id="edit-event-img" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#7a3229] outline-none">
                </div> 
                ...
                <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-4 py-2 bg-[#7a3229] text-white rounded-lg font-semibold hover:bg-red-900 transition shadow-sm">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
