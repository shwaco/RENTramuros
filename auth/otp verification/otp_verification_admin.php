...
<html lang="en">
  ...
  <?php
    if($success) {
        ...
        <strong>Success!</strong> Your account is verified. You can now <a href="login_admin.php" class="alert-link">Log In</a>.
  ...
  ?>
    ...
    <div class="container mt-5" style="max-width: 500px;">
        ...
        <form action="otp_verification_admin.php" method="POST">
          <div class="mb-3">
