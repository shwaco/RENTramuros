...
<html lang="en">
    ...
    <link rel="stylesheet" href="../../shared/components/map/style.css">

    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>

    <script src="../../shared/components/map/main.js" defer></script>
  ...
  <body>
    ...
    <div id="search-container">
        ...
        <datalist id="intramuros-locations">
              ...
              <option value="San Agustin Convent Museum">
              <option value="San Agustin Church">
              <option value="Centro de Turismo Intramuros">
