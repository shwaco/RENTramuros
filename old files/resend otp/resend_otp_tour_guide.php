...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "SELECT * FROM `tour_guides` WHERE email='$email' AND is_verified=0";
    ...
    if($result && mysqli_num_rows($result) > 0) {
        ...
        $update_sql = "UPDATE `tour_guides` SET otp='$new_otp' WHERE email='$email'";
        ...
        try {
            ...
            header("location: auth/otp verification/otp_verification_tour_guide.php");
            exit();
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5" style="max-width: 500px;">
        ...
        <form action="auth/resend otp/resend_otp_tour_guide.php" method="POST">
          <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <a href="auth/log in/login_tour_guide.php" class="text-decoration-none">Back to Login</a>
        </div>
    </div>
