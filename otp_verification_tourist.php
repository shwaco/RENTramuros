...
if(!isset($_SESSION['temp_email'])) {
    header("location: signup_tourist.php");
    exit();
}
...
<html lang="en">
  ...
  <?php
    if($success) {
        ...
        <strong>Success!</strong> Your account is verified. You can now <a href="login_tourist.php" class="alert-link">Log In</a>.
  ...
  ?>
    ...
    <div class="container mt-5" style="max-width: 500px;">
        ...
        <form action="otp_verification_tourist.php" method="POST">
          <div class="mb-3">
