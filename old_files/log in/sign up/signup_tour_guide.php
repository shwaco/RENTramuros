...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($result) {
        ...
        if($num>0) {
            ...
            $sql="INSERT INTO `tour_guides` (`email`, `password_hash`,  `first_name`, `last_name`, `otp`, `is_verified`) 
                  VALUES ('$email', '$hashed_password', '$first_name', '$last_name', '$otp', 0)";
            $result=mysqli_query($con, $sql);
...
?>
    <h1 class="text-center">Sign-up Page (Tour Guide)</h1>
    <div class="container mt-5">
        <form action="auth/sign up/signup_tour_guide.php" method="POST">
   <div class="mb-3">
