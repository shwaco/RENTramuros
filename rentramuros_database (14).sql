...
(1, 'Recommended', 'Fort Santiago', 'Sta. Clara St, Intramuros, Manila, 1002 Metro Manila, Philippines', 'A historic citadel built by Spanish navigator Miguel López de Legazpi.', '7:00 AM - 7:00 PM', 100.00, '6156791707530366599.jpg', '6156791707530366599.jpg', '6156791707530366599.jpg', '6156791707530366599.jpg'),
...
(76, 1, 'Attractions', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, NULL, NULL, 2, 0, NULL),
(77, 1, 'Attractions', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, NULL, 42, 2, 0, NULL),
(78, 1, 'Attractions', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, NULL, 43, 2, 0, NULL),
(79, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 47, 2, 0, NULL),
(80, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 48, 2, 0, NULL),
(81, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 49, 2, 0, NULL),
(82, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 50, 2, 0, NULL),
(83, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 51, 2, 0, NULL),
(84, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 52, 2, 0, NULL),
(85, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 53, 2, 0, NULL),
(86, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 2, 54, 2, 0, NULL),
(87, 1, 'Packages', 'Pending', '08:00 AM', 'November 12, 2026', 2, 0, 0, 3, 55, 2, 0, NULL);
...
(42, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(43, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(47, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(48, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(49, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(50, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(51, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(52, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(53, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(54, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380'),
(55, 'Lencey', 'Boi', 'lenceybou12@gmail.com', '09082970380');
...
(1, 'Hero\'s Trail', 'Walk the paths our national hero once roamed. This package is a focused tour of the history of Jose Rizal and it\'s main historical sites. Walk through Fort Santiago and Rizal Shrine, and immerse yourself in the Rizal Bagumbayan Light and Sound Museum while using Bambike as a fun way of exploration.', 250.00, '6154443154988404815.jpg'),
(2, 'Cultural Combo', 'A showcase of the cultural heritage and colonial lifestyle of the walled city. This combo focuses on Intramuros\' social, cultural, and culinary history. The itinerary features Casa Manila, an experience at Barbara\'s, and concluding at Silahis to appreciate authentic hand-crafted souvenirs.  ', 100.00, '6154443154988404815.jpg'),
(3, 'Walled City Grand Tour', 'The definitive Intramuros journey, covering the most iconic locations and highlights. It provides a comprehensive tour, being the best choice for a full-scale overview. It shows the architectural grandeur of the Minor Basilica, and San Agustin, while experiencing history in the form of Fort Santiago and Casa Manila.', 500.00, '6154443154988404815.jpg'),
(4, 'Bastions and Walls', 'Find out about the engineering and structural ingenuity that defines the walled city. This itinerary guides you through the district\'s perimeter, showing key picturesque defensive points such as Puerta del Parian, Puerta Real, and Fort Santiago. It ends in Palacio del Gobernador, where you learn about the political context and administrative power that the fortifications were made to protect.', 100.00, '6154443154988404815.jpg'),
(5, 'Sacred Route', 'A tour focused on the spiritual and architectural heart of the city. It highlights the Baroque architecture and religious legacy that is central to the identity of Intramuros. Visit and appreciate the Minor Basilica and San Agustin Church, which are two of the religious landmarks that have stood the test of time.', 200.00, '6154443154988404815.jpg');
...
INSERT INTO `request_packages` (`booking_request_id`, `package_id`) VALUES
(86, 2),
(87, 3);
...
--
ALTER TABLE `booking_history`
  MODIFY `booking_request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT for table `contact_information`
--
ALTER TABLE `contact_information`
  MODIFY `contact_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
